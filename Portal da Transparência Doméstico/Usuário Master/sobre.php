              ...
              <div class="col-md-4 d-flex justify-center align-center flex-column">
                  <div class="card">
                      <div class="content">
                        ...
                        <img alt="foto da turma" class="img-no-padding img-responsive" style="margin:auto;margin-top: 20px;" src="/ptdomestico master/assets/img/aturma.jpg"/>
                        </div>
              ...
              <div class="col-md-4 d-flex justify-center align-center flex-column">
                    <div class="card">
                        ...
                        <div class="content">
                          ...
                          <img alt="logo do projeto" class="img-no-padding img-responsive" style="margin:auto; margin-top: 20px;" src="/ptdomestico master/assets/img/logozinha.png"/>
