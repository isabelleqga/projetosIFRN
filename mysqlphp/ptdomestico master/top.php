...
<head>
    ...
    <link rel="stylesheet" style="text/css" href="/ptdomestico master/assets/css/custom.css">
    ...
    <div class="wrapper">
        <div class="sidebar" data-background-color="white" data-active-color="danger">
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a class="simple-text" href="http://localhost/ptdomestico%20master/index.php">
                        <big>PT
                ...
                <ul class="nav">
                    ...
                    <!--Master-->
                    <li>
                        <a href="/ptdomestico master/usuario/usuario-listar.php" <?php echo strrpos($_SERVER["REQUEST_URI"], "usuario") ? "style=\"color:#144E8C; background-color:#EEEEEE;\"" : ""; ?>>
                            <i class="ti-world"></i>
                            <p>Usuários</p>
                        </a>
                    </li>
                    <!--/Master-->
                    <li>
                        <a href="/ptdomestico master/sobre.php" <?php echo strrpos($_SERVER["REQUEST_URI"], "sobre.php") ? "style=\"color:#144E8C; background-color:#EEEEEE;\"" : ""; ?>>
                            <i class="ti-user"></i>
                            <p>Sobre Nós</p>
                        </a>
                    </li>
        ...
        <div class="main-panel">
            <div class="row" style="
                ...
                <div class="col-lg" id="header-mobile">
                    <a class="navbar-brand" id="navbard-brand-mobile" style="color: #777; font-weight: bold" href="#">Usuário Master</a>
